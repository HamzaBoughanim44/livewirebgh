                                    ...
                                    <li>
                                        <ul class="sidebar-menu-collapse">
                                            ...
                                            <li class="sidebar-menu-collapse-list">
                                                <div class="accordion">
                                                    <a href="{{route('product.category',['category_slug'=>$category->slug])}}" class="accordion-title collapsed" aria-expanded="false">{{ $category->name}}</a>
                                                    ...
                                                    @if (count($category->subCategories)>0)
                                                    <div id="{{$category->slug}}" class="collapse">
                                                        <ul class="accordion-category-list">
                                                            @foreach ($category->subCategories as $scategory)
                                                            <li><a href="{{route('product.category',['category_slug'=>$category->slug,'subcategory_slug'=>$scategory->slug])}}">{{$scategory->name}}</a></li>
                                                            @endforeach
                                                        </ul>
                                                    </div> 
                                                    @endif
                    ...
                    <div class="sidebar-single-widget">
                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="filter-type-price">
                                <h2 class="container">${{$min_price}} - ${{$max_price}}</h2>
                    ...
                    <div class="sidebar-single-widget">
                        <div class="sidebar-content">
                            <a href="product-details-default.html" class="sidebar-banner img-hover-zoom">
                                <img class="img-fluid" src="{{asset('assets/images/product/default/home-1/side-banner.jpg')}}" alt="">
                            </a>
                        </div>
                    </div> <!-- End Single Sidebar Widget -->
                        ...
                        <div class="row">
                            ...
                            <div class="sort-box d-flex justify-content-between align-items-md-center align-items-start flex-md-row flex-column"
                                ...
                                <div class="sort-select-list d-flex align-items-center">
                                    ...
                                    <form action="#">
                                        <fieldset>
                                            <select name="speed" id="speed" wire:model="sorting">
                            ...
                            <div class="col-12">
                                <div class="tab-content tab-animate-zoom">
                                    ...
                                    <div class="tab-pane active show sort-layout-single" id="layout-3-grid">
                                        @php
                                        $witems = Cart::instance('cart')->content()->pluck('id');
                                        @endphp
                                        <div class="row">
                                                    ...
                                                    <div class="image-box">
                                                        ...
                                                        <div class="action-link">
                                                            ...
                                                            <div class="action-link-right">
                                                                ...
                                                                <a href="#" wire:click.prevent="addToWishlist({{$product->id}},'{{$product->name}}',{{$product->regular_price}})"><i
                                                                        class="icon-heart"></i>
                                                                </a>
                                                                <a href="#"><i
