...
<main id="main" class="main-site">
  <style>
    input[type=password], .summary-item .row-in-form input[type=tel] {
    font-size: 13px;
    line-height: 19px;
                    ...
                    <div class="wrap-address-billing">
                        ...
                        <div class="billing-address">
                            ...
                            <p class="row-in-form">
                                ...
                                <input type="text" name="firstname" value="firstname" placeholder="Your name" wire:model="firstname">
                                @error('firstname')
                            ...
                            <p class="row-in-form">
                                ...
                                <input type="number" name="mobile" value="" placeholder="phone" wire:model="mobile">
                                @error('mobile')
                                <p class="text-danger">{{$message}}</p>
                                @enderror
                ...
                <div class="col-md-12">
                    <div class="wrap-address-billing">
                        ...
                        <div class="billing-address">
                            ...
                            <p class="row-in-form">
                                <label for="country">Province<span>*</span></label>
                                <input  type="text" name="country" value="" placeholder="United States" wire:model="s_province">
                                @error('s_province')
                                <p class="text-danger">{{$message}}</p>
                                @enderror
                            </p>
                   ...
                   @if($paymentmode == 'card') 
                    <div class="wrap-address-billing">
                        ...
                        <p class="row-in-form">
                            ...
                            <input  type="text" name="cart-number" value="" placeholder="Cart Number" wire:model="card_no">
                            @error('card_no')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </p>
                        ...
                        <p class="row-in-form">
                            ...
                            <input  type="text" name="cart-number" value="" placeholder="YYYY" wire:model="exp_year">
                            @error('exp_year')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </p>
                        ...
                        <p class="row-in-form">
                            ...
                            <input  type="password" name="cart-number" value="" placeholder="CVC" wire:model="cvc">
                            @error('cvc')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </p>
                    ...
                    <button class="btn btn-md btn-black-default-hover mb-4" type="submit" >Place order now</button>
                </div>
