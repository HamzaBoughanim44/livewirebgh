...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="categories">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="{{route('admin.addcategories')}}">Add Categories</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="products">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="{{route('admin.addproducts')}}">Add Products</a></li>
            ...
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="collapse" href="#attribut" aria-expanded="false" aria-controls="ui-basic">
                <span class="menu-title">Attribut</span>
                <i class="menu-arrow"></i>
                <i class="mdi mdi-medical-bag menu-icon"></i>
              </a>
              <div class="collapse" id="attribut">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{route('admin.attribut')}}">All Attribut</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{route('admin.addattribut')}}">Add Attribut</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="slider">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{route('admin.slider')}}">All Slider</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{route('admin.addhomeslider')}}">Add Slider</a></li>
            ...
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="collapse" href="#coupons" aria-expanded="false" aria-controls="ui-basic">
              ...
              <div class="collapse" id="coupons">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="{{route('admin.addcoupons')}}">Add Coupons</a></li>
            ...
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="collapse" href="#homecategories" aria-expanded="false" aria-controls="ui-basic">
                <span class="menu-title">Home Categories</span>
                <i class="menu-arrow"></i>
                <i class="mdi mdi-crosshairs-gps menu-icon"></i>
              </a>
              <div class="collapse" id="homecategories">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{route('admin.homecategories')}}">HomeCategories</a></li>
        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="container-fluid d-flex justify-content-between">
              <span class="text-muted d-block text-center text-sm-start d-sm-inline-block">Copyright © hamza boughanim</span>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.17.37/js/bootstrap-datetimepicker.min.js" integrity="sha512-Y+0b10RbVUTf3Mi0EgJue0FoheNzentTMMIE2OreNbqnUPNbQj8zmjK3fs5D2WhQeGWIem2G2UkKjAL/bJ/UXQ==" crossorigin="anonymous" ></script>
