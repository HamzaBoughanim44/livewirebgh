...
class Editcategory extends Component
{
    ...
    public function updateCategory(){
        ...
        session()->flash('message','Category has benn updated successfully :)');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.categories.editcategory',['categories'=>$categories])->layout('layouts.admin');
    }
}
