...
class EditProducts extends Component
{
    ...
    public function mount($product_slug){
        ...
        $this->inputs = $product->attributeValues->where('product_id',$product->id)->unique('product_attributes_id')->pluck('product_attributes_id');
        $this->attribute_arr = $product->attributeValues->where('product_id',$product->id)->unique('product_attributes_id')->pluck('product_attributes_id');
        foreach($this->attribute_arr as $a_arr){
            $allAttributeValue = AttributeValue::where('product_id',$product->id)->where('product_attributes_id',$a_arr)->get()->pluck('value');
            $valueString = '';
    ...
    public function updateProduct(){
        ...
        session()->flash('message','This Product has been update succssfully :)');
    }
